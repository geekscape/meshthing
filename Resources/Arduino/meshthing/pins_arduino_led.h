...
const uint8_t PROGMEM digital_pin_to_port_PGM[] = {
	...
	PB	, // PB 4 ** 11 ** PWM1		-- 7
	PE	, // PE 5 ** 12 ** PWM3?(OC3C/Int5)--14	
	PD	, // PD 0 ** 13 ** SCL/ON	-- 13
	PE	, // PE 2 ** 14 ** SDCD/DAT2	-- SDCard Pin 2	
	PB	, // PB 3 ** 15 ** MISO		-- SDCard Pin 7 (Dat0)
	PB	, // PB 1 ** 16 ** SCK		-- SDCard Pin 5 (Clk)	
	PB	, // PB 2 ** 17 ** MOSI		-- SDCard Pin 3 (CMD/DI)
	PD	, // PD 3 ** 18 ** USART1_TX	-- XBee Pin 2
	PD	, // PD 2 ** 19 ** USART1_RX	-- XBee Pin 3
